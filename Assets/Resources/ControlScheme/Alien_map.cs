...
//     version 1.7.0
//     from Assets/Resources/ControlScheme/Alien_map.inputactions
//
...
public partial class @Alien_map: IInputActionCollection2, IDisposable
{
    ...
    {
        private @Alien_map m_Wrapper;
        public AlienMapActions(@Alien_map wrapper) { m_Wrapper = wrapper; }
